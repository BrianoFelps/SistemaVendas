...
public class ListMarca extends javax.swing.JFrame {
    ...
    public void listarPorId(int pId){
        try{
            ...
            ResultSet resultset = daomar.listarPorId(pId);
     ...
     public void listarPorNome(String pNome){
                    try{
                        ...
                        ResultSet resultset = daomar.listarPorNome(pNome);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(tfFiltro, javax.swing.GroupLayout.DEFAULT_SIZE, 615, Short.MAX_VALUE)
                .addContainerGap())
