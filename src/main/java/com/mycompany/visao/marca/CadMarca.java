...
public class CadMarca extends javax.swing.JFrame {
    ...
    private void btnAcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcaoActionPerformed
        ...
        private void inserir(){
            ...
            if(daomar.inserir(Integer.parseInt(tfId.getText()), tfNome.getText())){
                JOptionPane.showMessageDialog(null, "Marca salva com sucesso!");
                
                tfId.setText("" + daomar.buscarProximoId());
                tfNome.setText("");
            } else {
        ...
        if(daomar.alterar(Integer.parseInt(tfId.getText()), tfNome.getText())){
        ...
        if(daomar.excluir(Integer.parseInt(tfId.getText()))){
